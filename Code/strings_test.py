...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains(' ', ' ') is True  # both spaces?
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('azd', 'zad') is False  # reordered
        assert contains('', 'please dont work') is False  # should fail i hope
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('acdcasdasd', 's') == 5 # extremely overlapping
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('aaaaa', 'a') == 0  # all the same
        assert find_index('aaaaa', '') == 0  # Empty string matches between each
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('abcddd', 'd') == [3, 4, 5]  # all at end
        assert find_all_indexes('dabcdd', 'd') == [0, 4, 5]  # one at beginning
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('', 'abc') == []  # When the text is empty and
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('aaaaa', 'a') == [0, 1, 2, 3, 4]  # all the same
        assert find_all_indexes('aaaaa', '') == [0, 1, 2, 3, 4]  # Empty string matches between each
